...
console.log("✓ MandateProfile conectado ao painel v2");
console.log("✓ timeline legada removida");
console.log("✓ wrapper temporário de diagnóstico removido");
