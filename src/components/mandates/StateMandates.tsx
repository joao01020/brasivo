...
export default function StateMandates({ uf }: { uf: string }) {
  ...
  return <main className="parliamentary-page"><header className="parliamentary-topbar"><Link className="brand" href="/"><span>BR</span><b>A</b><span>SIVO</span></Link><Link className="parliamentary-back" href="/"><ArrowLeft size={15}/>Voltar ao mapa</Link></header>
